...
const url = "https://apiasistencia1.azurewebsites.net/api/alumno/";
//en inputs: true: 1er valor, false:2do//ojo en js puedes cambiar el Tipod en tiempo de ejecucion
...
class ManAlumno extends Component {
  ...
  //estado y genero se guardan en bd como bit:1 o 0
    metodoGet = () => {     //si funca
        fetch(url)       //obtiene la lista
            ...
            .then(lista => {
                this.setState({  //setea la lista actualizando
                    lista
                })
            });
    ...
    metodoPost = async () => {    //no funca pero si con postman
        ...
        await fetch(url, {
            ...
            .then(response => {
                this.modalInsertar();
                this.metodoGet();        //luego de insertar,lista
            }).catch(error => {
                ...
                <div className="row">
                    <div className="col-12">
                        <table className="table">
                            ...
                            <tbody>
                                {this.state.lista.map((alumno,key=alumno.aluid) => {
                                    return (
                                        <tr>
                                            <td>{alumno.dni}</td>
                        ...
                        <Modal isOpen={this.state.modalInsertar}>    
                            ...
                            <ModalBody>
                                <div className="form-group">
                                    <label htmlFor="aluid">ID</label>
                                    <input className="form-control" type="text" name="aluid" id="aluid" readOnly
                                        onChange={this.cargarDatos}    value={datos ? datos.aluid:''}></input><br />                                    
                                    <label htmlFor="aluestado">Estado (true o false):</label>
                 <select className="form-control" name="aluestado" id="aluestado"  onChange={this.cargarDatos} value={datos ? datos.aluestado :''}>
                            ...
                            <option value="false">Inactivo</option>
                                    ...
                                    <input className="form-control" type="text" name="apellidomat" id="apellidomat"
                                        onChange={this.cargarDatos}   value={datos ? datos.apellidomat:''}></input>
                    ...
                    <select className="form-control" name="genero" id="genero" onChange={this.cargarDatos} value={datos ? datos.genero:''} >
                            <option value="true">Activo</option>
                            <option value="false">Inactivo</option>
                    </select>                                    
